...
//
//  Created by Nomcebo Duma on 2023/06/23.
//
...
class CustomTableViewController: UITableViewController {
    ...
    class AddVC:  UITableViewController {
        override func  viewDidLoad() {
            super.viewDidLoad()
            view.backgroundColor = .white
    ...
    class  UITableViewController :  UITabBarController, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate  {
